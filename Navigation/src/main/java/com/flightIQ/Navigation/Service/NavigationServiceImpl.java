...
public class NavigationServiceImpl implements Navigation_svc {
     ...
     ******************************************************/
    @Override
    public String GetATISOFDestination(String latitudeString, String longitudeString, String DestAirportCode) {
        // TODO Auto-generated method stub

        // http://localhost:8080/api/v1/getATISOfDestination?airportCode=KJFK
        ...
        Airport destAirport = getAirportFromICAO((DestAirportCode));
        double destAirportLat = destAirport.getLatitude(); 
    ...
    public double haversine_formula(String latitudeStr, String longitudeStr, double dest_latStr, double dest_longStr) {
        /*
         * Add static if testing
         * Remove static if done testing
         */
        ...
        double dest_latitude = Math.toRadians(dest_latStr); 
        double dest_longitude = Math.toRadians(dest_longStr); 
    ...
    //         double groundspeed = Double.parseDouble(ComputeTrueCourseAndGroundsped(course, avgwinds, Integer.parseInt(TAS)).split("-")[1]);
